...
providing themes and scales. This package uses by default the palette
defined in the 2024 Brand Guidelines document found on pages 19-21.
...
`theme_idea_min()` or `theme_idea_light()` instead.
